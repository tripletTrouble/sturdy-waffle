    ...
    <div class="grid space-y-5">
      ...
      <div class="grid gap-3">
        <div class="grid space-y-1">
          ...
          <div class="text-xs">
            You can sync your task to Google Sheet. <a href="#a" class="text-blue-500">Learn More</a>
          </div>
        </div>
        <div>
            <Textarea bind:value={syncUrl} placeholder="https://script.google.com/123abc"></Textarea>
        </div>
      </div>
    </div>
    <DialogFooter>
